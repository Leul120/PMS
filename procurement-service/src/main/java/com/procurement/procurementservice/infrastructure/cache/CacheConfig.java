...
public class CacheConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory cf) {
        ...
        return RedisCacheManager.builder(cf).cacheDefaults(cfg)
            .withCacheConfiguration("purchaseOrders", cfg.entryTtl(Duration.ofMinutes(20)))
            .withCacheConfiguration("purchaseRequisitions", cfg.entryTtl(Duration.ofMinutes(15)))
