package com.procurement.analyticsservice.infrastructure.cache;
...
public class CacheConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory cf) {
        ...
        return RedisCacheManager.builder(cf).cacheDefaults(cfg)
            .withCacheConfiguration("spendingReports", cfg.entryTtl(Duration.ofMinutes(10)))
            .withCacheConfiguration("vendorAnalytics", cfg.entryTtl(Duration.ofMinutes(15)))
            .withCacheConfiguration("procurementMetrics", cfg.entryTtl(Duration.ofMinutes(5)))
