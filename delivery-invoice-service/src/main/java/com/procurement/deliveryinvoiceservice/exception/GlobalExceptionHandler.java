package com.procurement.deliveryinvoiceservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException ex) {
        ...
        } else if (msg.contains("not open") || msg.contains("deadline") || msg.contains("cannot")
                || msg.contains("insufficient") || msg.contains("not pending")) {
